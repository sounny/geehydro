// Earth Engine catchment polygon generation from basin raster
...
var runBtn = ui.Button('Generate Basin Polygons');
var panel = ui.Panel([
...
runBtn.onClick(function() {
  ...
  var polys = basins.reduceToVectors({
    geometry: aoi,
    scale: scale,
    labelProperty: 'basin',
  ...
  Map.clear();
  Map.addLayer(polys, {color: 'blue'}, 'Basin Polygons');
